...
LivechatWidgetComponent.ɵfac = function LivechatWidgetComponent_Factory(t) { return new (t || LivechatWidgetComponent)(); };
LivechatWidgetComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: LivechatWidgetComponent, selectors: [["livechat-widget"]], inputs: { licenseId: "licenseId", group: "group", chatBetweenGroups: "chatBetweenGroups", params: "params", visitor: "visitor", gaVersion: "gaVersion" }, outputs: { onChatLoaded: "onChatLoaded", onAfterLoad: "onAfterLoad", onBeforeLoad: "onBeforeLoad", onChatEnded: "onChatEnded", onChatStarted: "onChatStarted", onChatStateChanged: "onChatStateChanged", onChatWindowHidden: "onChatWindowHidden", onChatWindowMinimized: "onChatWindowMinimized", onChatWindowOpened: "onChatWindowOpened", onMessage: "onMessage", onPostchatSurveySubmitted: "onPostchatSurveySubmitted", onPrechatSurveySubmitted: "onPrechatSurveySubmitted", onRatingCommentSubmitted: "onRatingCommentSubmitted", onRatingSubmitted: "onRatingSubmitted", onTicketCreated: "onTicketCreated", onWidgetResize: "onWidgetResize" }, decls: 0, vars: 0, template: function LivechatWidgetComponent_Template(rf, ctx) { }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LivechatWidgetComponent, [{
        type: Component,
        args: [{
                selector: 'livechat-widget',
                template: ""
            }]
    }], function () { return []; }, { onChatLoaded: [{
            type: Output
        }], onAfterLoad: [{
            type: Output
        }], onBeforeLoad: [{
...
LivechatWidgetModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LivechatWidgetModule });
LivechatWidgetModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LivechatWidgetModule_Factory(t) { return new (t || LivechatWidgetModule)(); }, imports: [[]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LivechatWidgetModule, { declarations: [LivechatWidgetComponent], exports: [LivechatWidgetComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LivechatWidgetModule, [{
        type: NgModule,
        args: [{
                imports: [],
