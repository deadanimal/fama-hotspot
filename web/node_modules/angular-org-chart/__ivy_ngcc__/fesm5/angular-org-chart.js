...
function OrgChartComponent_org_chart_entity_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(0, "org-chart-entity", 3);
    ɵngcc0.ɵɵlistener("toggleChild", function OrgChartComponent_org_chart_entity_0_Template_org_chart_entity_toggleChild_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r561); var ctx_r560 = ɵngcc0.ɵɵnextContext(); return ctx_r560.toggleShowChild($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r558 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("data", ctx_r558.data)("hasParent", ctx_r558.hasParent)("hideChild", ctx_r558.hideChild);
} }
function OrgChartComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelement(5, "div", 6);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelement(6, "angular-org-chart", 8);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
    var data_r562 = ctx.$implicit;
    var isFirst_r563 = ctx.first;
    var isLast_r564 = ctx.last;
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵstyleProp("border-color", isFirst_r563 ? "transparent" : "");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵstyleProp("border-color", isLast_r564 ? "transparent" : "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("data", data_r562)("hasParent", true);
} }
...
OrgChartComponent.ɵfac = function OrgChartComponent_Factory(t) { return new (t || OrgChartComponent)(); };
OrgChartComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: OrgChartComponent, selectors: [["angular-org-chart"]], inputs: { hasParent: "hasParent", data: "data" }, decls: 3, vars: 4, consts: [[3, "data", "hasParent", "hideChild", "toggleChild", 4, "ngIf"], [1, "org-chart-container"], [4, "ngFor", "ngForOf"], [3, "data", "hasParent", "hideChild", "toggleChild"], [1, "org-chart-sub-container"], [1, "org-chart-connector-container"], [1, "org-chart-connector", "org-chart-entity-border"], [1, "org-chart-entity-border"], [3, "data", "hasParent"]], template: function OrgChartComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, OrgChartComponent_org_chart_entity_0_Template, 1, 3, "org-chart-entity", 0);
        ɵngcc0.ɵɵelementStart(1, "div", 1);
        ɵngcc0.ɵɵtemplate(2, OrgChartComponent_ng_container_2_Template, 7, 6, "ng-container", 2);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.data);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵstyleProp("display", ctx.hideChild ? "none" : "flex");
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngForOf", ctx.data == null ? null : ctx.data.children);
    } }, directives: function () { return [ɵngcc1.NgIf, ɵngcc1.NgForOf, EntityComponent,
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(OrgChartComponent, [{
        type: Component,
        args: [{
...
EntityComponent.ɵfac = function EntityComponent_Factory(t) { return new (t || EntityComponent)(); };
EntityComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: EntityComponent, selectors: [["org-chart-entity"]], inputs: { hasParent: "hasParent", data: "data", hideChild: "hideChild" }, outputs: { toggleChild: "toggleChild" }, decls: 7, vars: 4, consts: [["class", "org-chart-entity-connector org-chart-entity-border", 4, "ngIf"], [1, "org-chart-entity-box", 3, "click"], [1, "org-chart-entity-name"], [1, "org-chart-entity-type"], [1, "org-chart-entity-connector", "org-chart-entity-border"]], template: function EntityComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, EntityComponent_div_0_Template, 1, 0, "div", 0);
        ɵngcc0.ɵɵelementStart(1, "div", 1);
        ɵngcc0.ɵɵlistener("click", function EntityComponent_Template_div_click_1_listener($event) { return ctx.toggleShowChild(); });
        ...
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtemplate(6, EntityComponent_div_6_Template, 1, 0, "div", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.hasParent);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵtextInterpolate(ctx.data == null ? null : ctx.data.name);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵtextInterpolate(ctx.data == null ? null : ctx.data.type);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", (ctx.data == null ? null : ctx.data.children.length) && !ctx.hideChild);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EntityComponent, [{
        type: Component,
        args: [{
...
OrgChartModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: OrgChartModule });
OrgChartModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function OrgChartModule_Factory(t) { return new (t || OrgChartModule)(); }, imports: [[
            CommonModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(OrgChartModule, { declarations: function () { return [OrgChartComponent,
        EntityComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [OrgChartComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(OrgChartModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
