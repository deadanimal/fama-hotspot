...
export class ActivityDetailsComponent implements OnInit, OnDestroy {
  ...
  addActivityDetailsForm: FormGroup;
  editActivityDetailsForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.ActivityData.getOne(this.proid).subscribe((res) => {
      this.listActivity = res;
      // this.tableRows = [...res];

      console.log("data = ", this.listActivity);
  ...
  addActivityDetails() {
    ...
    this.ActivityData.create(this.addActivityDetailsForm.value).subscribe(
      () => {
        // Success
  ...
  editActivityDetails() {
    ...
    this.ActivityData.update(
      this.editActivityDetailsForm.value.id,
      this.editActivityDetailsForm.value
    ).subscribe(
      () => {
        // Success
        // this.isLoading = false
  ...
  openModal(modalRef: TemplateRef<any>, row) {
    if (row) {
      console.log(row);
      this.editActivityDetailsForm.patchValue(row);
    }
  ...
  closeModal() {
    this.modal.hide();
    this.editActivityDetailsForm.reset();
  }
