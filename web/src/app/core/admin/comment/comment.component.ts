...
export class CommentComponent implements OnInit, OnDestroy {
  ...
  createCommentdetailsform: FormGroup;
  ...
  ngOnInit() {
    ...
    this.createCommentdetailsform = this.formBuilder.group({
    ...
    this.commentDetailsEditForm = this.formBuilder.group({
      id: new FormControl(""),
      comment: new FormControl(""),
      user_id: new FormControl(""),
      phase: new FormControl(""),
  ...
  openModal(modalRef: TemplateRef<any>, row) {
    if (row) {
      console.log(row);
      this.commentDetailsEditForm.patchValue(row);
    }
  ...
  closeModal() {
    this.modal.hide();
    this.commentDetailsEditForm.reset();
  }
